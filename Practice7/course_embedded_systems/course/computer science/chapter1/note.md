...
- [[#Вычислительное мышление|Вычислительное мышление]]
	- [[#Вычислительное мышление#Позиционные системы счисления|Позиционные системы счисления]]
	- [[#Вычислительное мышление#Преобразование чисел|Преобразование чисел]]
- [[#Текст|Текст]]
- [[#Emojis|Emojis]]
- [[#RGB|RGB]]
- [[#Images, Video and Sound|Images, Video and Sound]]
- [[#Алгоритмы|Алгоритмы]]
- [[#Псевдокод и основные структурные элементы программирования|Псевдокод и основные структурные элементы программирования]]
- [[#Системы счисления|Системы счисления]]
	- [[#Системы счисления#Шестидесятеричная система счисления|Шестидесятеричная система счисления]]
	- [[#Системы счисления#Двоичная система счисления|Двоичная система счисления]]
	- [[#Системы счисления#Восьмеричная и шестнадцатеричная системы счислений|Восьмеричная и шестнадцатеричная системы счислений]]
- [[#Работа с командной строкой в Windows: основные команды, навигация по файловой системе, создание и удаление файлов и папок.|Работа с командной строкой в Windows: основные команды, навигация по файловой системе, создание и удаление файлов и папок.]]
	- [[#Работа с командной строкой в Windows: основные команды, навигация по файловой системе, создание и удаление файлов и папок.#Навигация по файловой системе|Навигация по файловой системе]]
	- [[#Работа с командной строкой в Windows: основные команды, навигация по файловой системе, создание и удаление файлов и папок.#Создание и удаление файлов и папок|Создание и удаление файлов и папок]]
	- [[#Работа с командной строкой в Windows: основные команды, навигация по файловой системе, создание и удаление файлов и папок.#Примеры команд|Примеры команд]]
	- [[#Работа с командной строкой в Windows: основные команды, навигация по файловой системе, создание и удаление файлов и папок.#Файлы & Папки|Файлы & Папки]]
	- [[#Работа с командной строкой в Windows: основные команды, навигация по файловой системе, создание и удаление файлов и папок.#Команды работы с дисками и разделами|Команды работы с дисками и разделами]]
	- [[#Работа с командной строкой в Windows: основные команды, навигация по файловой системе, создание и удаление файлов и папок.#Сетевые команды|Сетевые команды]]
	- [[#Работа с командной строкой в Windows: основные команды, навигация по файловой системе, создание и удаление файлов и папок.#Информация о системе и команда конфигурирования|Информация о системе и команда конфигурирования]]
	- [[#Работа с командной строкой в Windows: основные команды, навигация по файловой системе, создание и удаление файлов и папок.#Команды настройки командной строки|Команды настройки командной строки]]
- [[#Написание простых bat-файлов: создание файловой структуры, запуск программ, передача параметров и другие простые команды.|Написание простых bat-файлов: создание файловой структуры, запуск программ, передача параметров и другие простые команды.]]
	- [[#Написание простых bat-файлов: создание файловой структуры, запуск программ, передача параметров и другие простые команды.#Создание файловой структуры|Создание файловой структуры]]
	- [[#Написание простых bat-файлов: создание файловой структуры, запуск программ, передача параметров и другие простые команды.#Запуск программ|Запуск программ]]
	- [[#Написание простых bat-файлов: создание файловой структуры, запуск программ, передача параметров и другие простые команды.#Передача параметров|Передача параметров]]
	- [[#Написание простых bat-файлов: создание файловой структуры, запуск программ, передача параметров и другие простые команды.#Простые команды|Простые команды]]
	- [[#Написание простых bat-файлов: создание файловой структуры, запуск программ, передача параметров и другие простые команды.#Использование переменных и условных операторов в bat-файлах: объяснение простых конструкций, включая условные операторы if-else и операторы цикла.|Использование переменных и условных операторов в bat-файлах: объяснение простых конструкций, включая условные операторы if-else и операторы цикла.]]
	- [[#Написание простых bat-файлов: создание файловой структуры, запуск программ, передача параметров и другие простые команды.#Операторы перенаправления ввода-вывода|Операторы перенаправления ввода-вывода]]
	- [[#Написание простых bat-файлов: создание файловой структуры, запуск программ, передача параметров и другие простые команды.#Оператор конвейера|Оператор конвейера]]
	- [[#Написание простых bat-файлов: создание файловой структуры, запуск программ, передача параметров и другие простые команды.#Операторы объединения команд|Операторы объединения команд]]
	- [[#Написание простых bat-файлов: создание файловой структуры, запуск программ, передача параметров и другие простые команды.#Оператор разыменования переменной|Оператор разыменования переменной]]
	- [[#Написание простых bat-файлов: создание файловой структуры, запуск программ, передача параметров и другие простые команды.#Объявление и использование переменных|Объявление и использование переменных]]
- [[#Условные операторы if-else|Условные операторы if-else]]
- [[#Операторы цикла|Операторы цикла]]
- [[#Функции|Функции]]
- [[#Введение в файловую систему: объяснение структуры файловой системы, работа с директориями и файлами, понятие пути к файлу.|Введение в файловую систему: объяснение структуры файловой системы, работа с директориями и файлами, понятие пути к файлу.]]
	- [[#Введение в файловую систему: объяснение структуры файловой системы, работа с директориями и файлами, понятие пути к файлу.#Файловая система Windows|Файловая система Windows]]
	- [[#Введение в файловую систему: объяснение структуры файловой системы, работа с директориями и файлами, понятие пути к файлу.#Окружение Windows 10|Окружение Windows 10]]
	- [[#Введение в файловую систему: объяснение структуры файловой системы, работа с директориями и файлами, понятие пути к файлу.#Структура файловой системы|Структура файловой системы]]
	- [[#Введение в файловую систему: объяснение структуры файловой системы, работа с директориями и файлами, понятие пути к файлу.#Работа с директориями и файлами|Работа с директориями и файлами]]
	- [[#Введение в файловую систему: объяснение структуры файловой системы, работа с директориями и файлами, понятие пути к файлу.#Понятие пути к файлу|Понятие пути к файлу]]
- [[#Основы редактирования текстовых файлов: работа с текстовыми файлами с помощью команды edit, открытие, редактирование, сохранение и закрытие файлов.|Основы редактирования текстовых файлов: работа с текстовыми файлами с помощью команды edit, открытие, редактирование, сохранение и закрытие файлов.]]
	- [[#Основы редактирования текстовых файлов: работа с текстовыми файлами с помощью команды edit, открытие, редактирование, сохранение и закрытие файлов.#Открытие файла|Открытие файла]]
	- [[#Основы редактирования текстовых файлов: работа с текстовыми файлами с помощью команды edit, открытие, редактирование, сохранение и закрытие файлов.#Редактирование файла|Редактирование файла]]
	- [[#Основы редактирования текстовых файлов: работа с текстовыми файлами с помощью команды edit, открытие, редактирование, сохранение и закрытие файлов.#Сохранение и закрытие файла|Сохранение и закрытие файла]]
	- [[#Основы редактирования текстовых файлов: работа с текстовыми файлами с помощью команды edit, открытие, редактирование, сохранение и закрытие файлов.#Операторы перенаправления вывода в файл|Операторы перенаправления вывода в файл]]
	- [[#Основы редактирования текстовых файлов: работа с текстовыми файлами с помощью команды edit, открытие, редактирование, сохранение и закрытие файлов.#Примеры использования|Примеры использования]]
...
---
Задания : [[computer science/chapter1/task]]
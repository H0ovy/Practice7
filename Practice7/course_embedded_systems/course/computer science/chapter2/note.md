...
- [[#top — table of process|top — table of process]]
- [[#|]]
- [[#Работа в оболочке|Работа в оболочке]]
- [[#Разделение аргументов|Разделение аргументов]]
- [[#Возможность компоновки|Возможность компоновки]]
- [[#Контроль работ и процессов|Контроль работ и процессов]]
- [[#Флаги|Флаги]]
- [[#Практические примеры|Практические примеры]]
	- [[#Практические примеры#Мониторинг подключения usb-устройств|Мониторинг подключения usb-устройств]]
	- [[#Практические примеры#Мониторинг подключения устройств с помощью dmesg|Мониторинг подключения устройств с помощью dmesg]]
	- [[#Практические примеры#Мониторинг оставшегося места на диске|Мониторинг оставшегося места на диске]]
---
## Мотивация
